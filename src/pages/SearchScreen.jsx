    ...
    <div className='container '>
      ...
      <div className='row'>
        <div className='col-6'>
          ...
          <form onSubmit={handleSubmit}>
            <label className='form-label w-100' >
              Character:{""} <input placeholder='Name Character' type="text" className='form-control' value={inputValue}
        ...
        <div className="col-6">
          ...
          {
            characters.length=== 0 && (<div className='alert alert-warning text-center' >Busca otro caracter</div>)
          }
