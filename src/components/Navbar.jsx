        ...
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarNav">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li className="nav-item">
              <NavLink activeClassName='active text-white' className="nav-link" aria-current="page" to="/womans">Womans</NavLink>
              </li>
              <li className="nav-item">
            ...
            <div className='d-flex'>
                <button className='btn btn-danger' onClick={handleLogaut}>Logaut</button>
            </div>
          </div>
        </div>
      </nav>
